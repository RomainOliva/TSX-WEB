<div ng-controller="ctrlTabs" data-job="131">
	...
	<div class="tab-content" style="width:100%;">
		<div role="tabpanel" class="tab-pane active" ng-show="tabs=='desc'">
					...
					<hr class="featurette-divider">
					<p>Fondée en 2007, nous avons très vite conquis le marché militaire et publique.<br />
					Notre entreprise est connue pour ses feux d'artifice annuel mais aussi pour son ingéniosité quand à la conception des explosifs.</p>
					<hr class="featurette-divider">
					<h2 class="text-center">Informations :</h2><br />
					<hr class="featurette-divider">
					<p><u>Siè</u>g<u>es social :</u> Ruelle sombre</p><br/>
					<p><u>Portefeuille de propriété intellectuelle :</u> Des dizaines de brevets axé sur les technologies d'armement chimique pour l'armée.</p><br />
					<p><u>Distinctions :</u> En 2016, notre entreprise à reçu le prix de "Meilleur feux d'artifice de l'année" pour la 8ème année consécutive !
				
					<hr class="featurette-divider">
					<h2 class="text-center">Recrutement :</h2><br />
					<hr class="featurette-divider">
					<p>Nous sommes actuellement à la recherche de chimiste amateur ou experimenté dans la concoction de feux d'artifice.<br />
					La mairie nous ayant confié un contrat d'exclusivité sur l'armement et l'animation de la ville, nous avons besoin de beaucoup de personel !</p>
					<br />
